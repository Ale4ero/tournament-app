...
/**
 * PlayInBracketView - Renders brackets for "play-in" style tournaments
 * where all teams play in the first round (no byes).
 * Uses mathematical positioning where matches pair sequentially.
 */
export default function PlayInBracketView({ playoffMatches, playoffSeeding }) {
      ...
      <div className="hidden lg:block overflow-x-auto pb-8">
        ...
        <div className="flex items-start min-w-max" style={{ minHeight: '500px' }}>
          ...
          {rounds.map((round, roundIndex) => {
            ...
            return (
              <div key={round} className="flex-1 px-5 pb-2.5 pl-4 flex flex-col">
